package es.cloud4dev.opensouthcode.demo.views.masterdetail;
...
import es.cloud4dev.opensouthcode.demo.data.entity.SamplePerson;
import es.cloud4dev.opensouthcode.demo.data.service.SamplePersonService;
